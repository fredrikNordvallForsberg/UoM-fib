...
% \note{****Add to other document that it is easy to generate ``free theorems'' in MonSet fibration and there are many examples especially when playing around with \qnt(u) and arrows}

...
The Abelian group object $G$ in $\B$ 
corresponds to a product-preserving functor
$F:\LAb\to \B$ from the Lawvere theory for Abelian groups:
the object $1$ in $\LAb$ is a generic Abelian group, 
and $F(1)=G$.  

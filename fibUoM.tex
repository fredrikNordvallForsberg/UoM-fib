...
$B$ of physical dimensions (e.g.\ length, time, mass etc.), let $G$ be
...
$\overline{\text{length}} = m$, $\overline{\text{time}} = s$,
...
$\lambda\forall$-fibration if $\C$ is Cartesian closed.

...
In otherwords, it is interpreted as the set of functions that are equivariant
...
When $Q=G$,
we can also accommodate a term constant
...
\[+ :\forall X.\,\qnt(X)\times\qnt(X)\to\qnt(X)\text.\]

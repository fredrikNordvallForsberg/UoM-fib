...
\begin{example}(A Parametric Model Built from Group Actions)
\label{ex:MonAct}
...
\begin{example}(A Parametric Model Built from Groupoid-actions)
\label{ex:presheaves}
...
In this section we will look in greater detail at the $\lambda D$-model given by the $\GrpSet$ fibration, and so we spell out the reindexing and simple product structure.

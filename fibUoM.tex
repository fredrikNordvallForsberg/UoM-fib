...
Let $\Cat$ be the category of small categories and functors. Then the forgetful functor $\CatSet\to \Cat$, which we call the $\CatSet$ fibration, is a $\lambda \forall$-model. The proof of this is very similar to Example~\ref{ex:MonAct}.
...
$\Cat$, and, moreover, every Abelian group in $\Cat$ arises in this way.

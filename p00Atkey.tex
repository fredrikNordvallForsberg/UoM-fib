...
In general, a useful way of building fibrations is by changing the base. If $p:\E\to \B$ be a fibration, and $F:\A\to \B$ is a functor, then the pullback of $p$ along $F$ in $\Cat$, denoted $F^\ast p : F^\ast \E \rightarrow \A$, is again a fibration. The same is true of $\lambda D$-models.
\begin{theorem}
